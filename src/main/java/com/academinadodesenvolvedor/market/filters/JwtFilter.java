package com.academinadodesenvolvedor.market.filters;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    private final UserServiceContract userSerrvice;
    ...
    public JwtFilter(JwtServiceContract jwtServiceContract,
        ...
        this.userSerrvice = userServiceContract;
    }
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer")) {
            ...
            try {
                String email = this.jwtService.decode(token)
                        ...
                        .asString();
                if (tokenIsValid) {
                    UserDetails user = this.userSerrvice.loadUserByUsername(email);
